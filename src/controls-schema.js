  ...
  const CONTROLS = [
    ...
    { key: "csgshine", host: "fx", group: "csg", type: "dual", label: "Shine", valId: "vCsgShine", min: 0, max: 3, step: 0.01, lo: 1.25, hi: 1.25, fmt: v => sig3(v), apply: v => csgShine = v, durScale: 10 },
    { key: "csgwidth", host: "fx", group: "csg", type: "dual", label: "Highlight width", valId: "vCsgWidth", min: 0, max: 1, step: 0.01, lo: 0.21, hi: 0.21, fmt: v => sig3(v), apply: v => csgWidth = v, durScale: 10 },
    ...
    { key: "carule", host: "fx", group: "ca", type: "dual", single: true, label: "Rule", valId: "vCaRule", min: 0, max: 5, step: 1, lo: 0, hi: 0, fmt: v => ["Life", "HighLife", "Day & Night", "Seeds", "Maze", "Coral"][Math.round(v)] || "Life", apply: v => caRuleI = Math.round(v), durScale: 10 },
    { key: "cacells", host: "fx", group: "ca", type: "dual", single: true, label: "Cells", valId: "vCaCells", min: 40, max: 400, step: 1, lo: 120, hi: 120, fmt: v => sig3(Math.round(v)) + " across", apply: v => caCols = Math.round(v), durScale: 10 },
    { key: "caspeed", host: "fx", group: "ca", type: "dual", label: "Speed", valId: "vCaSpeed", min: 1, max: 60, step: 1, lo: 12, hi: 12, fmt: v => sig3(v) + " gen/s", apply: v => caSpeedV = v, durScale: 10 },
    { key: "carain", host: "fx", group: "ca", type: "dual", label: "Rain", valId: "vCaRain", min: 0, max: 0.05, step: 0.0005, lo: 0.002, hi: 0.002, fmt: v => sig3(v * 100) + "%", apply: v => caRain = v, durScale: 10 },
    { key: "catrail", host: "fx", group: "ca", type: "dual", label: "Trail", valId: "vCaTrail", min: 0, max: 200, step: 1, lo: 12, hi: 12, fmt: v => sig3(Math.round(v)) + " gens", apply: v => caTrail = v, durScale: 10 },
    { key: "cagain", host: "fx", group: "ca", type: "dual", label: "Brightness", valId: "vCaGain", min: 0.4, max: 1.5, step: 0.02, lo: 1, hi: 1, fmt: v => sig3(v) + "×", apply: v => caGain = v, durScale: 10 },
    ...
    { key: "pyseed", host: "fx", group: "poly", type: "dual", single: true, label: "Seed", valId: "vPySeed", min: 1, max: 999, step: 1, lo: 3, hi: 3, fmt: v => "#" + Math.round(v), apply: v => pySeed = Math.round(v), durScale: 10 },
    { key: "pyjump", host: "fx", group: "poly", type: "dual", label: "Jump", valId: "vPyJump", min: 0.2, max: 0.9, step: 0.01, lo: 0.62, hi: 0.62, fmt: v => sig3(v), apply: v => pyJump = v, durScale: 10 },
    { key: "pywiggle", host: "fx", group: "poly", type: "dual", label: "Wiggle", valId: "vPyWiggle", min: 0, max: 1, step: 0.01, lo: 0.25, hi: 0.25, fmt: v => sig3(v), apply: v => pyWiggle = v, durScale: 10 },
  ...
  const CTL_GROUPS = {
    ...
    stars: "Starfield", aurora: "Aurora", rd: "Reaction-diffusion", ca: "Cellular automata", menger: "Menger sponge",
    boids: "Boids", galaxy: "Galaxy", harmo: "Harmonograph", poly: "Polypinski", vballs: "Vector balls", ocean: "Ocean",
  ...
  const PHASE_VARS = [
    ...
    ["csgTime", () => csgTime, v => csgTime = v],
    ["csgOrbT", () => csgOrbT, v => csgOrbT = v],
