  ...
  const CONTROLS = [
    ...
    { key: "pydepth", host: "fx", group: "poly", type: "dual", label: "Depth fade", valId: "vPyDepth", min: -1, max: 1, step: 0.01, lo: 0.45, hi: 0.45, fmt: v => sig3(v), apply: v => pyDepth = v, durScale: 10 },
